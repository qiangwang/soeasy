...
public class HttpManager {
     ...
     * @throws IOException
     */
    public static APIResult openUrl(String url, String method,
            APIParameters params, String file) throws IOException {
        ...
        if (method.equals(HTTPMETHOD_GET)) {
            ...
            if (!TextUtils.isEmpty(file)) {
                ...
                String postParam = Utility.encodeUrl(params);
        ...
        return new APIResult(result, statusCode, url);
    }
    ...
    private static void paramToUpload(OutputStream baos, APIParameters params)
            throws IOException {
